// Paste your two Supabase values here, then save this file and upload it.
// These two values are safe to keep in plain view. They do not grant access
...
export const SUPABASE_URL = "https://byexuitovolaahjnjaro.supabase.co/rest/v1/";
